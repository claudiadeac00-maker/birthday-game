    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      const value =
        !labelKey && typeof label === "string"
          ? getPayloadConfigFromPayload(item, label, config)?.label || label
          : itemConfig?.label;
...
function getPayloadConfigFromPayload(
  ...
  return configLabelKey && config ? config[configLabelKey] : undefined;
}

const ChartConfigContext = React.createContext<ChartConfig | null>(null);

function ChartConfigProvider({ children, config }: { children: React.ReactNode; config: ChartConfig }) {
